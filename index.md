...
address: "Murray Learning Centre - UG10"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Monday 17th and Tuesday 18th December 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Mark Slater", "Laurence Hurst"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p id="requirements">
  ...
  <li>They are also required to abide by
  {% if page.carpentry == "swc" %}
